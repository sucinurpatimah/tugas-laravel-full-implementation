...
@section('title', 'Halaman Tambah Data Produk')
...
@section('content')
    <div class="container">
        ...
        @endif
        <div class="row">
            <div class="col-md-4 offset-4 rounded bg-info mt-3 py-3 mb-3">
                <h2 class="text-center fw-bold" style="font-size: 20px">Tambah Data Produk</h2>
                <form class="mt-3" action="{{ route('dashboard.admin.store') }}" method="POST"
                    ...
                    <div class="d-flex">
                        <div class="mx-auto">
                            <a href="{{ route('dashboard.admin.index') }}" class="btn btn-warning me-2">
                                Kembali</a>
