...
@section('title', 'Halaman Manage Product')
        ...
        <div class="row bg-info rounded px-3 py-3 w-100">
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-end">
                    <a href="#" class="btn btn-md btn-primary fw-bold my-auto me-1">Lihat Profil</a>
                    <a href="{{ route('dashboard.admin.add') }}" class="btn btn-md btn-dark fw-bold my-auto me-1">Tambah
                        Produk</a>
                    <a href="#" class="btn btn-md btn-success fw-bold my-auto me-1">Import Product</a>
                    <a href="#" class="btn btn-md btn-warning fw-bold my-auto me-1">Export Product</a>
                </div>
            </div>
                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr>
                            ...
                            @endif
                            <td class="d-flex">
                                <a href="{{ route('dashboard.admin.edit', ['id' => $product->id]) }}"
                                    class="btn btn-warning btn-sm">Update</a>
                                <form action="{{ route('dashboard.admin.delete', ['id' => $product->id]) }}" method="POST"
                                    class="ms-1">
                                    @csrf()
